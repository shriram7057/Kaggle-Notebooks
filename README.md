...
│   ├── Exercise-lists.ipynb
│   ├── Exercise-loops-and-list-comprehensions.ipynb
...
│
├── Kaggle-Advanced SQL-Notebooks/
│   ├── Exercise-joins-and-unions.ipynb
│   ├── Exercise-analytic-functions.ipynb
│   ├── Exercise-writing-efficient-queries.ipynb
│   └── Exercise-nested-and-repeated-data.ipynb
│
